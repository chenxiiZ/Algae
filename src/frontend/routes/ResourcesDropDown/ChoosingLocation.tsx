    ...
    return (
        <div className="bg-cover h-full w-full flex justify-center" style={{ backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)), url(${Beach})`,}}>
            <div className="m-[100px] w-[1000px] h-auto bg-[#E7E7E7] p-[40px]">
                ...
                <p className="text-[19px]">Selecting the right location is crucial for collecting high-quality water
                    samples. Look for a site with
                    ...
                    areas with excessive debris or sediment, as these can cloud your sample and make microscopic
                    analysis
                ...
                <img src="../../../../public/LabPic/ocean.jpg" alt="lab" className="m-5 w-[350px] h-[250px]"/>
            </div>
        </div>
    );
}